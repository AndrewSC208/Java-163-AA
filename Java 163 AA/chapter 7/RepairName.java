...
public class RepairName {
  public static void main(String[] args) {
    ...
    name = JOption.showInputDialog(null, "Please enter your first and last name");
    ...
    for(i=0; i < string.Length(); i++)
    {
      ...
      if(i == 0)
      {
        ...
        name = c + name.substring(1, string.Length());
      }
      else
      {
    ...
    for(i=0; i < stringLength; i++)
    {
      ...
      else
      {
        if(name.charAt(i) == ' ')
        {
          ...
          c = name.charAt(i);
          c = Character.toUpperCase(c);
          name = name.substring(0, i) + c + name.substring(i + 1, string.Length());
        }
      }
    }
